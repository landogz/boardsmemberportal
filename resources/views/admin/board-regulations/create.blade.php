        ...
        <form id="createRegulationForm" class="space-y-6">
            <div>
                ...
                <textarea 
                    ...
                    placeholder="Enter full regulation title (no character limit)"
                ></textarea>
            ...
            <input type="hidden" id="version" name="version" value="{{ old('version', date('Y') . '.01') }}">
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($noticeOfMeetingNotices ?? [] as $nom)
                            <option value="{{ $nom->id }}">{{ $nom->title }}{{ $nom->meeting_date ? ' (' . $nom->meeting_date->format('M d, Y') . ')' : '' }}</option>
                        @endforeach
                    </select>
