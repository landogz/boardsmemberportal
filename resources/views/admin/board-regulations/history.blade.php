...
<div class="p-4 lg:p-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">Document: <span class="font-semibold">{{ $regulation->title }}</span></p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <p class="text-sm font-medium text-gray-900">{{ $regulation->title }}</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="text-sm font-medium text-gray-900">{{ $regulation->approved_date ? $regulation->approved_date->format('M d, Y') : 'N/A' }}</p>
            </div>
            <div>
            ...
            <div class="md:col-span-2">
                ...
                <p class="text-sm text-gray-900">{{ $regulation->description }}</p>
            </div>
            @endif
            @if($regulation->pdf)
            <div class="md:col-span-2">
                ...
                >
                    <i class="fas fa-file-pdf mr-2"></i>{{ $regulation->pdf->file_name }}
                </button>
            </div>
            @endif
        </div>
                ...
                <table id="versionsTable" class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $version->approved_date ? $version->approved_date->format('M d, Y') : 'N/A' }}</div>
                            </td>
                            <td class="px-6 py-4">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#versionsTable').DataTable({
            order: [[8, 'desc']], // Sort by updated date descending (newest first)
            pageLength: 10,
            ...
            columnDefs: [
                { orderable: false, targets: [9] } // Disable sorting on PDF column
            ]
        });
        @endif
    });
