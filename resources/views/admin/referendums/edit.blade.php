...
<div class="p-4 lg:p-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form id="editReferendumForm" class="space-y-6">
            <!-- Two Column Layout -->
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            name="title" 
                            required
                            value="{{ old('title', $referendum->title) }}"
                    ...
                    <div>
                        ...
                        >{{ old('content', $referendum->content) }}</textarea>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            name="expires_at" 
                            required
                            value="{{ old('expires_at', $referendum->expires_at->format('Y-m-d H:i')) }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#055498] focus:border-[#055498] outline-none transition"
...
<script>
    ...
    // Form submission
    document.getElementById('editReferendumForm').addEventListener('submit', async function(e) {
        e.preventDefault();
        ...
        try {
            const response = await axios.post('{{ route("admin.referendums.update", $referendum->id) }}', formData, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            });
            ...
            if (response.data.success || response.status === 200) {
                Swal.fire({
                    icon: 'success',
                    title: 'Success!',
                    text: 'Ad Referendum updated successfully.',
                    timer: 1500,
                    showConfirmButton: false
                }).then(() => {
