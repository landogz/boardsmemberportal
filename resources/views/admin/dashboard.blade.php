                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6 border border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-2xl sm:text-3xl font-bold text-gray-900 mt-1 sm:mt-2" id="totalUsers">{{ \App\Models\User::count() }}</p>
                            </div>
                <div class="h-10 w-10 sm:h-12 sm:w-12 rounded-lg flex items-center justify-center flex-shrink-0 ml-2" style="background-color: rgba(251, 209, 22, 0.2);">
                    <i class="fas fa-users text-lg sm:text-xl" style="color: #FBD116;"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6 border border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="flex-1 min-w-0">
                                <p class="text-xs sm:text-sm font-medium text-gray-600">Announcements</p>
                                <p class="text-2xl sm:text-3xl font-bold text-gray-900 mt-1 sm:mt-2" id="totalAnnouncements">0</p>
                            </div>
                <div class="h-10 w-10 sm:h-12 sm:w-12 rounded-lg flex items-center justify-center flex-shrink-0 ml-2" style="background-color: rgba(5, 84, 152, 0.2);">
                    <i class="fas fa-bullhorn text-lg sm:text-xl" style="color: #055498;"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6 border border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="flex-1 min-w-0">
                                <p class="text-xs sm:text-sm font-medium text-gray-600">Meetings</p>
                                <p class="text-2xl sm:text-3xl font-bold text-gray-900 mt-1 sm:mt-2" id="totalMeetings">0</p>
                            </div>
                <div class="h-10 w-10 sm:h-12 sm:w-12 rounded-lg flex items-center justify-center flex-shrink-0 ml-2" style="background-color: rgba(5, 84, 152, 0.2);">
                    <i class="fas fa-calendar text-lg sm:text-xl" style="color: #055498;"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6 border border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="flex-1 min-w-0">
                                <p class="text-xs sm:text-sm font-medium text-gray-600">Resolutions</p>
                                <p class="text-2xl sm:text-3xl font-bold text-gray-900 mt-1 sm:mt-2" id="totalResolutions">0</p>
                            </div>
                <div class="h-10 w-10 sm:h-12 sm:w-12 rounded-lg flex items-center justify-center flex-shrink-0 ml-2" style="background-color: rgba(206, 32, 40, 0.2);">
                    <i class="fas fa-file-text text-lg sm:text-xl" style="color: #CE2028;"></i>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="rounded-lg shadow-sm p-4 sm:p-6 text-white cursor-pointer hover:shadow-md transition-shadow" style="background: linear-gradient(135deg, #055498 0%, #123a60 100%);" onclick="window.location.href='#'">
                        ...
                        <div class="space-y-1">
                            <div class="flex justify-between items-center">
                                ...
                                <strong class="text-lg sm:text-xl" id="boardMembers">0</strong>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-xs sm:text-sm opacity-90">Authorized Reps</span>
                                <strong class="text-lg sm:text-xl" id="authorizedReps">0</strong>
                            </div>
                        </div>
                    </div>
        ...
        <div class="rounded-lg shadow-sm p-4 sm:p-6 text-white cursor-pointer hover:shadow-md transition-shadow" style="background: linear-gradient(135deg, #FBD116 0%, #FBD116 100%); color: #123a60;" onclick="window.location.href='{{ route('admin.audit-logs.index') }}'">
                        ...
                        <div class="space-y-1">
                            <div class="flex justify-between items-center">
                                ...
                                <strong class="text-lg sm:text-xl" id="auditLogs">0</strong>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-xs sm:text-sm opacity-90">Today's Activities</span>
                                <strong class="text-lg sm:text-xl" id="todayActivities">0</strong>
                            </div>
                        </div>
                    </div>
                </div>
