...
@section('content')
                    ...
                    <div id="activeChat" class="flex flex-col h-full hidden" style="position: relative; display: flex; flex-direction: column;">
                        ...
                        <div class="p-3 sm:p-4 border-t border-gray-200 bg-gray-50 flex-shrink-0" style="position: relative; margin-top: 0px !important; display: block; visibility: visible;">
                            ...
                            <form id="messageForm" class="flex items-center space-x-1 sm:space-x-2" style="display: flex; visibility: visible;">
                                ...
                                <button type="button" id="attachBtn" class="p-2 sm:p-2.5 text-blue-600 hover:bg-gray-200 rounded-full transition min-w-[44px] min-h-[44px] flex items-center justify-center" title="Attach files">
                                    <i class="fas fa-paperclip text-base sm:text-lg"></i>
                                </button>
                                <button type="button" id="voiceBtn" class="p-2 sm:p-2.5 text-red-500 hover:bg-gray-200 rounded-full transition min-w-[44px] min-h-[44px] flex items-center justify-center" title="Record voice message">
                                    <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 14a3 3 0 0 0 3-3V5a3 3 0 0 0-6 0v6a3 3 0 0 0 3 3z"></path>
                                        <path d="M19 11a1 1 0 0 0-2 0 5 5 0 0 1-10 0 1 1 0 0 0-2 0 7.002 7.002 0 0 0 6 6.92V21h-2a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2h-2v-3.08A7.002 7.002 0 0 0 19 11z"></path>
                                    </svg>
                                </button>
                                <input type="text" id="messageInput" placeholder="Type a message..." class="flex-1 px-3 sm:px-4 py-2.5 sm:py-2 text-sm sm:text-base border border-gray-300 rounded-lg bg-white text-gray-800 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none">
                                <button type="button" id="emojiBtn" class="p-2 sm:p-2.5 text-yellow-500 hover:bg-gray-200 rounded-full transition min-w-[44px] min-h-[44px] flex items-center justify-center" title="Add emoji">
                                    <i class="fas fa-smile text-base sm:text-lg"></i>
                                </button>
    ...
    <script>
        ...
        function openChat(userId, userName, convData = null) {
            ...
            const indicatorColor = isGroup ? '' : (isOnline ? 'bg-green-500' : 'bg-gray-400');
            const indicatorHtml = !isGroup ? `<div class="absolute bottom-0 right-0 w-3 h-3 ${indicatorColor} rounded-full border-2 border-white"></div>` : '';
