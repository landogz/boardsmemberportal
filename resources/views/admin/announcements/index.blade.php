                                ...
                                <div class="flex-shrink-0">
                                    @php
                                        ...
                                        if ($creator) {
                                            ...
                                            $profileUrl = $profileMedia ? asset('storage/' . $profileMedia->file_path) : 'https://ui-avatars.com/api/?name=' . urlencode($creator->short_name) . '&size=40&background=055498&color=fff';
                                            $creatorName = $creator->short_name;
                                        } else {
