...
<div class="p-4 lg:p-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">Create a new announcement with banner image and user access control</p>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form id="createAnnouncementForm" action="{{ route('admin.announcements.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            <!-- Two Column Layout -->
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <!-- Right Column: Publish Box (WordPress style) and Allowed Users -->
    ...
    function previewBanner(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                // Remove click handler from upload area to prevent reopening file picker
