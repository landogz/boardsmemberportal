...
<script>
    ...
    function generatePrintContent(results, reportType, filters) {
        ...
        if (reportType !== 'quorum_guide') {
            ...
            filterInfo += '<div class="info-row"><span class="info-label">Report Type:</span><span class="info-value">' + (reportTypeNames[reportType] || reportType.replace(/_/g, ' ').replace(/\b\w/g, function(c) { return c.toUpperCase(); })) + '</span></div>';
...
<head>
    ...
    <title>${reportTypeNames[reportType] || reportType.replace(/_/g, ' ').replace(/\b\w/g, c => c.toUpperCase())} Report</title>
    <style>
            @page {
