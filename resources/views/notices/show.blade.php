            ...
            <div class="notice-header-content">
                ...
                <p class="notice-byline">
                    <span class="byline-item">
                        @php
                            // Avatar initials: CS
                            $creatorProfilePic = 'https://ui-avatars.com/api/?name=' . urlencode('CS') . '&size=64&background=055498&color=fff&bold=true';
                        @endphp
                        <img src="{{ $creatorProfilePic }}" alt="CS" class="byline-avatar">
                        <span class="byline-label">Created by</span>
                        <span class="byline-value">CONSEC</span>
                    </span>
                        ...
                        @if(in_array($attendanceConfirmation->status, ['accepted', 'declined']))
                            @if(!$isMeetingDone)
                                ...
                                <button type="button" class="btn-change-response {{ $attendanceConfirmation->status === 'accepted' ? 'btn-change-decline' : 'btn-change-accept' }}" onclick="{{ $attendanceConfirmation->status === 'accepted' ? 'declineNotice(' . $notice->id . ')' : 'acceptNotice(' . $notice->id . ', this, \'' . addslashes($notice->meeting_type ?? '') . '\')' }}">
                                    ...
                                    @else
                                        <i class="fas fa-edit"></i>
                                        <span>Change response to Accept</span>
                                    @endif
                                </button>
                            @endif
                                ...
                                <div class="attachment-card">
                                    ...
                                    @elseif($isVideo)
                                        <div class="attachment-preview file">
                                            <video controls class="h-full w-full object-cover rounded">
                ...
                <div class="mb-4">
                    ...
                    <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center">
                        ...
                        <div id="agendaDropZone" class="cursor-pointer">
                            ...
                            <p class="text-xs text-gray-500">Allowed: PDF, DOC, DOCX, XLS, XLSX, PPT, PPTX, JPG, PNG, GIF, MP4, MOV, AVI, WEBM, MKV. Maximum file upload size is 100MB per file.</p>
                        </div>
