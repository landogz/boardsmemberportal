...
<nav class="sticky top-[45px] z-50 bg-white/80 dark:bg-[#0F172A]/80 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800">
    <div class="container mx-auto px-4 py-4">
        <div class="flex items-center justify-between w-full">
            ...
            <div class="hidden lg:flex items-center space-x-4 xl:space-x-6 flex-shrink-0">
                ...
                <a href="#" onclick="event.preventDefault(); showNotApprovedModal();" class="text-sm xl:text-base transition whitespace-nowrap nav-link" style="color: inherit; hover:color: #055498;" onmouseover="this.style.color='#055498'" onmouseout="this.style.color='inherit'">Referendums</a>
    ...
    <div id="mobileMenu" class="hidden lg:hidden bg-white dark:bg-[#0F172A] border-t border-gray-200 dark:border-gray-800">
        <div class="container mx-auto px-4 py-4 space-y-3">
            ...
            <a href="#" onclick="event.preventDefault(); showNotApprovedModal();" class="block py-2 transition text-base min-h-[44px] flex items-center nav-link" style="color: inherit;" onmouseover="this.style.color='#055498'" onmouseout="this.style.color='inherit'">Referendums</a>
