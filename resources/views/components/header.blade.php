...
<nav class="sticky top-0 z-50 bg-white/80 dark:bg-[#0F172A]/80 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800">
    <div class="container mx-auto px-4 sm:px-6 md:px-8 py-3 md:py-4">
        <div class="flex flex-nowrap items-center justify-between w-full gap-4 min-h-[52px] md:min-h-[56px]">
            ...
            <div class="hidden xl:flex items-center space-x-4 xl:space-x-6 flex-shrink-0 min-h-[44px] items-center">
                ...
                <a href="{{ route('reference-materials.index') }}" class="inline-flex items-center text-sm xl:text-base transition whitespace-nowrap nav-link" style="color: inherit; hover:color: #055498;" onmouseover="this.style.color='#055498'" onmouseout="this.style.color='inherit'">Reference Materials</a>
                <a href="{{ route('referendums.index') }}" class="inline-flex items-center text-sm xl:text-base transition whitespace-nowrap nav-link" style="color: inherit; hover:color: #055498;" onmouseover="this.style.color='#055498'" onmouseout="this.style.color='inherit'">Ad Referendum</a>
                <a href="{{ route('notices.index') }}" class="inline-flex items-center text-sm xl:text-base transition whitespace-nowrap nav-link" style="color: inherit; hover:color: #055498;" onmouseover="this.style.color='#055498'" onmouseout="this.style.color='inherit'">Communication</a>
                @endauth
                @guest
    ...
    <div id="mobileMenu" class="hidden xl:hidden bg-white dark:bg-[#0F172A] border-t border-gray-200 dark:border-gray-800">
        <div class="container mx-auto px-4 py-4 space-y-3">
            ...
            <a href="{{ route('reference-materials.index') }}" class="block py-2 transition text-base min-h-[44px] flex items-center nav-link" style="color: inherit;" onmouseover="this.style.color='#055498'" onmouseout="this.style.color='inherit'">Reference Materials</a>
            <a href="{{ route('referendums.index') }}" class="block py-2 transition text-base min-h-[44px] flex items-center nav-link" style="color: inherit;" onmouseover="this.style.color='#055498'" onmouseout="this.style.color='inherit'">Ad Referendum</a>
            <a href="{{ route('notices.index') }}" class="block py-2 transition text-base min-h-[44px] flex items-center nav-link" style="color: inherit;" onmouseover="this.style.color='#055498'" onmouseout="this.style.color='inherit'">Communication</a>
            @endauth
            @guest
