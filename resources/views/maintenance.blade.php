...
<head>
    ...
    <title>Under Maintenance - Board Member Portal</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1>We'll Be Back Soon! <span class="pulse-dot"></span></h1>
        <p class="subtitle">We're currently performing scheduled maintenance</p>
        
        <div class="message">
            <p>We apologize for the inconvenience. Our team is working hard to improve your experience. We'll be back online shortly.</p>
        </div>
        ...
        <div class="contact-info">
            <p>For urgent matters, please contact us at <a href="mailto:{{ config('mail.from.address', 'rolan.benavidez@gmail.com') }}">{{ config('mail.from.address', 'rolan.benavidez@gmail.com') }}</a></p>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            // Get maintenance end time from config or use default
            const maintenanceEndDate = '{{ config("app.maintenance_end_date", "2026-01-20 12:00:00") }}';
            const endTime = new Date(maintenanceEndDate).getTime();
            ...
            function updateCountdown() {
                ...
                if (distance < 0) {
                    ...
                    $('#minutes').text('00');
                    $('#seconds').text('00');
                    $('.countdown-label').text('Maintenance should be complete soon!');
                    return;
                }
