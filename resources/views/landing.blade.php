...
<head>
    ...
    <style>
        ...
        /* YouTube/Vimeo embed: same structure as admin preview (absolute inset-0, always visible) */
        .banner-slide .banner-slide-embed-wrap {
            position: absolute;
            top: 0;
            left: 0;
            right: 0;
        ...
        .banner-slide .banner-slide-embed-wrap iframe {
            position: absolute;
            top: 0;
            left: 0;
            width: 100%;
    ...
    <div class="banner">
        <div class="banner-slideshow">
            @if(isset($bannerSlides) && $bannerSlides->count() > 0)
                ...
                @php
                    $hasMediaUrl = !empty($slide->media_url) && $slide->embed_url;
                    $hasMedia = $slide->media || $slide->mediaTablet || $slide->mediaMobile || $hasMediaUrl;
                ...
                <div class="banner-slide {{ $index === 0 ? 'active' : '' }}" style="{{ !$hasMedia ? 'background: linear-gradient(135deg, #055498 0%, #123a60 100%);' : '' }}">
                    ...
                    @endif
                    @if($hasMediaUrl)
                        <div class="banner-slide-embed-wrap absolute inset-0 flex items-center justify-center z-0" style="opacity: {{ $slide->media_opacity_value }};">
                            <iframe
                                class="absolute inset-0 w-full h-full border-0"
                                src="{{ e($slide->embed_url) }}"
                                title="Video"
                    ...
                    @endif
                    @if($slide->is_video && $desktopUrl && !$hasMediaUrl)
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center gap-2 sm:gap-3 flex-wrap mt-2 sm:mt-0">
                                ...
                                <div class="flex items-center gap-1 sm:gap-1.5">
                                    ...
                                    <span class="text-[10px] xs:text-xs sm:text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap">Communication</span>
                                </div>
                            </div>
                        </div>
    ...
    <section id="vision" class="py-12 sm:py-16 md:py-20 lg:py-24 bg-white dark:bg-[#0F172A]">
        <div class="container mx-auto px-4 sm:px-6">
            <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
                <!-- Vision -->
                <div class="group w-full min-w-0 rounded-2xl sm:rounded-3xl p-6 sm:p-8 mx-auto md:mx-0 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-[#055498]/20 hover:scale-[1.02]" style="background: linear-gradient(135deg, rgba(5, 84, 152, 0.2) 0%, rgba(18, 58, 96, 0.2) 100%); border: 1px solid rgba(5, 84, 152, 0.3);">
                    <h2 class="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-center">Vision</h2>
                ...
                <!-- Mission -->
                <div class="group w-full min-w-0 rounded-2xl sm:rounded-3xl p-6 sm:p-8 mx-auto md:mx-0 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-[#055498]/20 hover:scale-[1.02]" style="background: linear-gradient(135deg, rgba(5, 84, 152, 0.2) 0%, rgba(18, 58, 96, 0.2) 100%); border: 1px solid rgba(5, 84, 152, 0.3);">
                    <h2 class="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-center">Mission</h2>
                    <p class="text-base sm:text-lg text-gray-700 dark:text-gray-300 leading-relaxed text-justify">
                ...
                <!-- Mandate -->
                <div class="group w-full min-w-0 rounded-2xl sm:rounded-3xl p-6 sm:p-8 mx-auto md:mx-0 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-[#055498]/20 hover:scale-[1.02]" style="background: linear-gradient(135deg, rgba(5, 84, 152, 0.2) 0%, rgba(18, 58, 96, 0.2) 100%); border: 1px solid rgba(5, 84, 152, 0.3);">
                    <h2 class="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-center">Mandate</h2>
        ...
        <div class="container mx-auto px-4 sm:px-6">
            <div class="max-w-5xl mx-auto">
                <header class="text-center mb-12 sm:mb-16">
                    ...
                    <p class="mt-3 text-sm sm:text-base font-semibold text-[#055498] dark:text-[#5b9bd5] tracking-wide uppercase">2026 Directory of Board Members</p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mb-14 sm:mb-16">
                    ...
                    <article class="group rounded-2xl bg-gray-50 dark:bg-[#1e293b]/80 border border-[#055498]/15 dark:border-[#5b9bd5]/25 overflow-hidden text-center shadow-md shadow-[#055498]/5 transition-all hover:shadow-lg hover:shadow-[#055498]/10 ring-1 ring-[#055498]/10 dark:ring-[#5b9bd5]/20">
                        <div class="aspect-[3/4] max-w-[260px] mx-auto overflow-hidden bg-gray-200/50 dark:bg-gray-700/50">
                            <img src="https://ddb.gov.ph/wp-content/uploads/2025/02/sec-oca-pngg.png" alt="Secretary OSCAR FADER VALENZUELA" class="w-full h-full object-cover object-top transition-transform group-hover:scale-[1.02]" loading="lazy">
                        </div>
                        <div class="p-5 sm:p-6">
                            <p class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">Secretary</p>
                            <h3 class="text-base font-bold text-gray-900 dark:text-white leading-tight">
                                <span class="block">OSCAR FADER</span>
                                <span class="block">VALENZUELA</span>
                            </h3>
                            <p class="text-xs font-semibold text-[#055498] dark:text-[#5b9bd5] uppercase tracking-wide mt-2 mb-3">Chairman / Permanent Member</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mb-2">Permanent Alternate: Undersecretary Earl P. Saavedra</p>
                ...
                <!-- Board member groups (accordions) — 2026 Directory -->
                            ...
                            <table class="w-full min-w-[640px] text-sm text-left border-collapse">
                                <thead>
                                    <tr class="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 bg-gray-100/80 dark:bg-gray-800/80">
                                        ...
                                        <th class="px-4 py-3">Permanent Alternate</th>
                                    </tr>
                                </thead>
                                <tbody class="text-gray-700 dark:text-gray-300 divide-y divide-gray-100 dark:divide-gray-700/80">
                                    <tr class="hover:bg-gray-50/80 dark:hover:bg-gray-800/30 transition-colors"><td class="px-4 py-3 text-center align-top"><a href="https://www.doj.gov.ph/index.html" target="_blank" rel="noopener noreferrer"><img src="https://ddb.gov.ph/wp-content/uploads/2021/10/DOJ.jpg" width="80" height="78" alt="DOJ" class="mx-auto block rounded" loading="lazy"></a></td><td class="px-4 py-3"><strong>SECRETARY FREDDERICK VIDA</strong><br>Secretary, Department of Justice</td><td class="px-4 py-3"><strong>UNDERSECRETARY IAN NORMAN DATO</strong><br>Undersecretary, Department of Justice</td></tr>
                                    <tr class="hover:bg-gray-50/80 dark:hover:bg-gray-800/30 transition-colors"><td class="px-4 py-3 text-center align-top"><a href="https://doh.gov.ph" target="_blank" rel="noopener noreferrer"><img src="https://ddb.gov.ph/wp-content/uploads/2021/10/DOH.png" width="80" height="80" alt="DOH" class="mx-auto block rounded" loading="lazy"></a></td><td class="px-4 py-3"><strong>DR. JOSE S. PUJALTE, JR.</strong><br>Secretary, Department of Health</td><td class="px-4 py-3"><strong>UNDERSECRETARY ELMER PUNZALAN</strong><br>Undersecretary, Department of Health</td></tr>
