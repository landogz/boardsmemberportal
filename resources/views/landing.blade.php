...
<body class="bg-[#F9FAFB] dark:bg-[#0F172A] text-[#0A0A0A] dark:text-[#F1F5F9]">
    ...
    <section id="announcements" class="py-16 md:py-24 bg-white dark:bg-[#0F172A]">
        <div class="container mx-auto px-4">
            <h2 class="text-4xl md:text-5xl font-bold text-center mb-12 bg-gradient-to-r from-[#A855F7] to-[#3B82F6] bg-clip-text text-transparent">
                Public Announcements
            </h2>
            <div class="grid md:grid-cols-3 gap-6">
                <!-- Announcement Card 1 -->
                <div class="rounded-3xl p-6 bg-gradient-to-br from-[#A855F7]/10 to-[#3B82F6]/10 border border-[#A855F7]/20 hover:shadow-xl transition">
                    <div class="w-12 h-12 rounded-full bg-[#A855F7] flex items-center justify-center mb-4">
                    ...
                    <a href="#" class="text-[#A855F7] font-semibold hover:underline">Read More →</a>
                </div>
                <!-- Announcement Card 2 -->
                <div class="rounded-3xl p-6 bg-gradient-to-br from-[#10B981]/10 to-[#3B82F6]/10 border border-[#10B981]/20 hover:shadow-xl transition">
                    <div class="w-12 h-12 rounded-full bg-[#10B981] flex items-center justify-center mb-4">
                        <span class="text-2xl">📅</span>
                    </div>
                    ...
                    <a href="#" class="text-[#10B981] font-semibold hover:underline">Read More →</a>
                </div>
                <!-- Announcement Card 3 -->
                <div class="rounded-3xl p-6 bg-gradient-to-br from-[#3B82F6]/10 to-[#A855F7]/10 border border-[#3B82F6]/20 hover:shadow-xl transition">
                    <div class="w-12 h-12 rounded-full bg-[#3B82F6] flex items-center justify-center mb-4">
                        <span class="text-2xl">🎯</span>
                    </div>
                    ...
                    <a href="#" class="text-[#3B82F6] font-semibold hover:underline">Read More →</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="meetings" class="py-16 md:py-24 bg-gradient-to-br from-[#F9FAFB] to-gray-100 dark:from-[#0F172A] dark:to-[#1e293b]">
        <div class="container mx-auto px-4">
            <h2 class="text-4xl md:text-5xl font-bold text-center mb-12 bg-gradient-to-r from-[#3B82F6] to-[#10B981] bg-clip-text text-transparent">
                Public Meetings
            </h2>
    ...
    <section id="about" class="py-16 md:py-24 bg-gradient-to-br from-gray-50 to-white dark:from-[#1e293b] dark:to-[#0F172A]">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-4xl md:text-5xl font-bold mb-8 bg-gradient-to-r from-[#A855F7] to-[#10B981] bg-clip-text text-transparent">
                    About Us
                </h2>
    ...
    <section id="contact" class="py-16 md:py-24 bg-white dark:bg-[#0F172A]">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                <h2 class="text-4xl md:text-5xl font-bold text-center mb-12 bg-gradient-to-r from-[#3B82F6] to-[#A855F7] bg-clip-text text-transparent">
                    Contact Us
                </h2>
