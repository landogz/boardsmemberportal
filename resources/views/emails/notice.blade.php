                    ...
                    <tr>
                        <td class="email-body">
                            ...
                            <div class="button-container">
                                <a href="{{ $noticeUrl }}" class="button button-primary">View Notice</a>
                                <a href="{{ $acceptUrl }}" class="button button-success">Accept</a>
                                <a href="{{ $declineUrl }}" class="button button-danger">Decline</a>
                            </div>
