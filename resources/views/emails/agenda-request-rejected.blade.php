...
<head>
    ...
    <title>Agenda Request Rejected</title>
    <style>
        /* Reset styles */
...
@media only screen and (max-width: 600px) {
            ...
            .rejection-card { padding: 16px !important; }
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="email-wrapper" style="max-width: 100%; width: 100%;">
                    ...
                    <tr>
                        <td class="email-body">
                            ...
                            <p class="greeting">
                                We regret to inform you that your request for agenda inclusion has been rejected.
                            </p>
                            ...
                            <div class="rejection-card">
                                <h2 class="rejection-title">Rejection Notice</h2>
                                <p class="rejection-message">
                                    Your agenda inclusion request has been reviewed and unfortunately, it has been rejected.
                                </p>
                                
                                @if($agendaRequest->rejection_reason)
                                <div class="reason-box">
                                    <div class="reason-label">Rejection Reason</div>
                                    <p class="reason-text">{{ $agendaRequest->rejection_reason }}</p>
                                </div>
                                @endif
                            </div>
