                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" class="email-wrapper">
                    ...
                    <tr>
                        <td class="email-body">
                            ...
                            <p class="greeting">
                                A notice you were previously notified about has been updated. Please review the changes below.
                            </p>
                            ...
                            <div class="notice-card">
                                ...
                                <div class="notice-details">
                                    ...
                                    <div class="notice-content">
                                        {{ html_entity_decode(strip_tags($notice->description), ENT_QUOTES, 'UTF-8') }}
                                    </div>
                                    @endif
